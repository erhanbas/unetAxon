...
def generate_3D_unet(base_num_filters, num_classes, kernel_size=(3,3), image_width=128, image_height=128, image_depth=128):
        """
        ...
        up7 = concatenate([Conv3DTranspose(4*base_num_filters, kernel_size, strides=(2, 2), padding='same')(conv6), conv3], axis=4)
        ...
        up8 = concatenate([Conv3DTranspose(2*base_num_filters, kernel_size, strides=(2, 2), padding='same')(conv7), conv2], axis=4)
        ...
        up9 = concatenate([Conv3DTranspose(base_num_filters, kernel_size, strides=(2, 2), padding='same')(conv8), conv1], axis=4)
